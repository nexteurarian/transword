...
const crosswordData = {
  ...
  clues: {
    across: [
      { number: 1, clue: "used to indicate an exception or condition to what was previously stated" },
      { number: 2, clue: "used to introduce a point that happens after a particular event" },
    ],
    down: [{ number: 3, clue: "used when presenting a contrasting idea despite an earlier point" }],
  },
}
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <Card>
            ...
            <CardContent>
              <img
                src="https://i.ibb.co/TMCsNwz2/puzzlemaker.png"
