...
const crosswordData = {
  ...
  clues: {
    across: [
      { number: 1, clue: "used when we want to return to a previous point or topic" },
      { number: 2, clue: "used when we are expressing a conclusion based on reasoning" },
    ],
    down: [{ number: 3, clue: "used when something is true even though something else is also true" }],
  },
}
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <Card>
            ...
            <CardContent>
              <img
                src="https://i.ibb.co/mC7myNX8/puzzlemaker.png"
