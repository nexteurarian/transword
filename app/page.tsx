...
const crosswordData = {
  grid: [
    ...
    [null, "T", null, "R", null, null, null, null, null, null],
    [null, null, null, "E", null, null, null, null, "Y", null],
    [null, null, null, null, null, null, null, null, null, null],
    [null, null, null, null, null, null, null, null, null, null],
    [null, null, null, null, null, null, null, null, null, null],
    [null, null, null, null, null, null, null, null, null, null],
...
export default function HomePage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const result = await saveSubmission(studentName, essay, userAnswers)
      if (result.success) {
        toast({
    ...
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex justify-between items-center">
          ...
          <h1 className="text-2xl font-bold text-center">why are you here bro</h1>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <Card>
            ...
            <CardContent>
              <img
                src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-ZVCZnJ30KtJGUiiiUitluCKuTQv39T.png"
