...
const crosswordData = {
  ...
  clues: {
    across: [
      { number: 1, clue: "used when indicating a shift in focus or topic" },
      { number: 2, clue: "used to show that a point is true even with exceptions" },
    ],
    down: [{ number: 3, clue: "used to introduce an unexpected outcome" }],
  },
}
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <Card>
            ...
            <CardContent>
              <img
                src="https://i.ibb.co/BV4kyG1t/puzzlemaker.png"
