...
const crosswordData = {
  ...
  clues: {
    across: [
      { number: 1, clue: "used when expressing an idea that follows logically from the previous one" },
      { number: 2, clue: "used when replacing one idea or action with another" },
    ],
    down: [{ number: 3, clue: "used to show similarity or likeness between ideas" }],
  },
}
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <Card>
            ...
            <CardContent>
              <img
                src="https://i.ibb.co/8gjM27Sp/puzzlemaker.png"
